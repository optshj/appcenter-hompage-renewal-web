...
export function ProjectCard({ data }: { data: Project }) {
  ...
  return (
    ...
    >
      {data.images ? (
        <Image src={imageArray[0]} alt="Recruitment Thumbnail" width={1920} height={1020} quality={100} className="h-auto w-full rounded-md object-cover sm:rounded-[28px]" unoptimized />
      ) : (
